...
<div class="packages">
    <div class="row align-items-center">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Packages</h3>
            </div>
        </div>
    </div>
    ...
    <ul class="nav nav-tabs d-flex flex-wrap justify-content-center align-items-center gap-15 border-0 text-center" id="myTab" role="tablist">
        <li class="nav-item flex-grow-1 shadow border-0">
            <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business" role="tab" aria-controls="business" aria-selected="false">Business</a>
        </li>
        <li class="nav-item flex-grow-1 shadow border-0">
            <a class="nav-link" id="purchase-tab" data-toggle="tab" href="#purchase" role="tab" aria-controls="purchase" aria-selected="true">Purchase</a>
        </li>
        <li class="nav-item flex-grow-1 shadow border-0">
            <a class="nav-link" id="smiles-tab" data-toggle="tab" href="#smiles" role="tab" aria-controls="smiles" aria-selected="false">Smiles</a>
        </li>
        <li class="nav-item flex-grow-1 shadow border-0">
    ...
    <div class="tab-content" id="myTabContent">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        <div class="addPackages text-md-right">
                            <a href="addPackages.php" class="btn">Add Packages</a>
                        </div>
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item mb-1" href="./business-plan.php" ><i class="bi bi-eye table-eye pr-2"></i>View</a>
        ...
        <div class="tab-pane fade" id="purchase" role="tabpanel" aria-labelledby="purchase-tab">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Purchase</h3>
            </div>
            <div class="notification-section shadow p-5 rounded-15 my-4">
                <div class="row justify-content-between">
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="addPackages text-md-right">
                            <a href="#" class="btn">Add Packages</a>
                        </div>
                        <div class="d-flex align-items-center flex-wrap selectBox gap-15 my-4">
                            <div class="title flex-shrink-0">
                                <p class="achivpFont mb-0">Filter By:</p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group ml-1">
                                            <button type="button" class="btn border-color outline-0" data-toggle="dropdown" aria-expanded="false"> <i class="bi bi-three-dots-vertical"></i> </button>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item mb-1" href="./smile-details.php"><i class="bi bi-eye table-eye pr-2"></i>View</a>
                                                <a class="dropdown-item mb-1"><i class="bi bi-x-circle pr-2"></i>In-Active</a>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="tab-pane fade" id="purchases" role="tabpanel" aria-labelledby="purchases-tab">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Purchases</h3>
            </div>
            <div class="notification-section shadow p-5 rounded-15 my-4">
                <div class="row justify-content-between">
                    <div class="col-md-12 mb-3">
