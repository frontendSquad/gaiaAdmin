<!-- successfull video updated -->
<div class="modal fade" id="videoUpdated" tabindex="-1" aria-labelledby="videoUpdatedLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="contentModal text-center px-md-5">
                    ...
                    <h3>Successully</h3>
                    <p>Video has been updated Successfully!</p>
                </div>
