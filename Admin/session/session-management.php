...
<div class="userSection">
    <div class="d-flex justify-content-between flex-wrap align-items-center">
        <div class="titleBox py-4">
            <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Services / Sessions Management</h3>
        </div>
        <div class="btnBox">
            <button type="button" class="btn bg-theme-primary text-white px-5 rounded-pill">Create Session</button>
        </div>
    </div>
                ...
                <table class="table text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="table-site-headings">Session ID</th>
                            <th class="table-site-headings">Service/Session Name</th>
