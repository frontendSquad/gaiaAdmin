    ...
    <div class="row align-items-center justify-content-between">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Service Logs</h3>
            </div>
        </div>
    </div>
                ...
                <table class="table text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="table-site-headings">Service Title</th>
                            <th class="table-site-headings">Date of Purchase</th>
