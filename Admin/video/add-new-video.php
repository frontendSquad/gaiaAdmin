    ...
    <div class="report-section shadow px-5 py-4 rounded-15 my-4">
        <form action="">
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="form-group py-2">
                        ...
                        <input type="text" name="videoTitle" class="form-control border-0 rounded-pill shadow" placeholder="Enter Title">
                    </div>
                    <div class="form-group py-2">
                        <label for="lastName">
                            Description:
            ...
            <div class="editBtn py-4">
                <button type="button" class="btn bg-theme-primary text-white px-5 rounded-pill py-2">Add</button>
            </div>
        </form>
    </div>
</div>
