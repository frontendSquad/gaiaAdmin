...
<div class="userSection">
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox border-bottom py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Users</h3>
            </div>
        </div>
        <div class="col-md-4 offset-md-8 m-0">
            <div class="d-flex justify-content-between shadow align-items-end p-3 my-4 flex-wrap">
                ...
                <div class="userStats">
                    <p class="mb-0"><i class="bi bi-arrow-up text-success"></i>100.0%</p>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-5">
            <div class="registerdUser">
                <div class="d-flex justify-content-between flex-wrap align-items-center flex-wrap flex-lg-nowrap">
                    <div class="title">
                        <h3 class="h5 mb-0 achivpFont">Registered Users Stats</h3>
                    </div>
                ...
                <div class="statsGraph">
                    <figure class="mb-0">
                        <img src="../images/user-stats.PNG" alt="" class="mw-100 w-100">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex flex-wrap gap-16">
                <div class="col-md-6">
                    <div class="contentBox registerdUser border my-3">
                        <p class="mb-0">Average Usage/ Month</p>
                        <figure class="mb-0">
                            <img src="../images/month-stats.PNG" alt="" class="mw-100">
                        </figure>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="contentBox registerdUser border my-3">
                        <div class="d-flex jusify-content-between flex-wrap flex-lg-nowrap align-items-center">
                            <p class="flex-grow-1 mb-0">Average Usage/ Month</p>
                            <select class="form-select form-select-sm pr-5 py-2 w-auto font-10" aria-label=".form-select-sm example">
    ...
    <div class="notification-section shadow p-5 rounded-15 my-4">
        <div class="row justify-content-between">
            ...
            <div class="col-md-4">
                <div class="d-flex align-items-center flex-wrap selectBox gap-15 mb-4">
        ...
        <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap align-items-center">
                <p class="mb-0">Showing 10 of 50 href="./user-details.php" Entries</p>
