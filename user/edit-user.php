    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><a href="./user.php" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i> Edit User</a></h3>
            </div>
        </div>
    </div>
    <div class="report-section shadow px-5 py-4 rounded-15 my-4">
        ...
        <form action="">
            ...
            <div class="editBtn py-4">
                <button type="button" class="btn bg-theme-primary text-white px-5 rounded-pill py-2" data-toggle="modal" data-target="#useradd">Update</button>
            </div>
        </form>
    </div>
</div>
